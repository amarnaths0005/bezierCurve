...
let line1, line2, line3, line4, line5, line6, controlLine;
let camRadius;
let curvePoints = [];
let noUPoints, uStep;
let curveLine;
...
function init() {
    ...
    p5xRange.addEventListener('input', function () {
    ...
    p5yRange.addEventListener('input', function () {
    ...
    p5zRange.addEventListener('input', function () {
...
function changeUvalue() {
    ...
    let u2, u3, u4, coeff1, coeff2, coeff3, coeff4, coeff5, xCurve, yCurve, zCurve;
...
function setupControlPoints() {
    ...
    geometry.vertices.push(point3.position);
    geometry.vertices.push(point4.position);
    geometry.vertices.push(point5.position);
